...
const materias: Materia[] = [{ materia: 'Português', assuntos: [{ nome: 'Crase', freq: 4, pdfUrl: 'assets/assuntos/crase.pdf', questions: [{ qid: 'test-1', prova: 'T1', ano: 2023, q: 1, d: 'facil', link: '#' }] }] }];
